...
void body_tick(body_t *body, double dt) {
  ...
  vector_t new_velocity = vec_add(old_velocity, vec_multiply(dt/body->mass, body->force));
  new_velocity = vec_add(new_velocity, vec_multiply(1/body->mass, body->impulse));
